...
def home(request):
    ...
    messages.error(request, 'Mensagem enviada de sucesso')
    messages.success(request, 'Mensagem enviada de sucesso')
    messages.info(request, 'Mensagem enviada de sucesso')
